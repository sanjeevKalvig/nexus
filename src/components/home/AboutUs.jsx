...
const AboutUs = () => {
  return (
    <div className="relative text-white overflow-hidden mb-20">
      ...
      <div className="relative z-10 gap-0 max-w-[1920px] mx-auto xl:pt-20 xl:pb-64 flex flex-col lg:flex-row xl:gap-16">
        ...
        <div className="flex-1 flex flex-col gap-1 mt-[7.5rem]"> 
          <div className="text-white py-20 px-6 md:px-12 lg:px-24 xl:px-24 xl:py-20">
            {/* Header */}
            <div className="mb-16">
              <h2 className=" text-[2.5rem] font-semibold leading-none 2xl:text-[5.625rem] 2xlplus:text-[8rem] "> 
                <span className="text-[#F4D48D]">ABOUT</span>{" "}
                <span className="text-white">US</span>
              </h2>
              <p className="text-[1.375rem] text-gray-300 mt-8 max-w-4xl  2xl:text-[1.375rem] 2xlplus:text-[2rem]"> 
            ...
            <div className="grid md:grid-cols-2 gap-16 xl:gap-16 ">
              <div>
                ...
                <h3 className="text-[2rem] text-[#F4D48D] font-semibold mb-4 2xlplus:text-[5rem] "> 
                  Mission
                </h3>
                <p className="text-[1.25rem] text-gray-300 leading-relaxed 2xl:text-[0.9375rem] 2xlplus:text-[1.5rem]"> 
              ...
              <div>
                ...
                <h3 className="text-[2rem] text-[#F4D48D] font-semibold mb-4 2xlplus:text-[5rem]"> {/* 32px */}
                  Vision
                </h3>
                <p className="text-[1.25rem] text-gray-300 leading-relaxed xl:text-[0.9375rem] 2xlplus:text-[1.5rem]"> {/* 20px, 15px */}
      ...
      <div className="relative z-20 mt-4 2xl:-mt-[27rem] px-6 md:px-12 lg:px-24 xl:px-24 max-w-[1920px] mx-auto 2xlplus:-mt-[20rem]"> {/* 432px → 27rem */}
        <div className="rounded-lg shadow-xl">
          <div className="flex items-center mb-12 h-auto">
            <h2 className="text-[2.5rem] font-semibold leading-none 2xl:text-[5.625rem] 2xlplus:text-[8rem]"> {/* 40px, 90px */}
            ...
            <img
              ...
              alt="Values Icon"
              className="w-[3.0625rem] h-[3.0625rem] object-contain ml-6 xl:w-[7.5rem] xl:h-[12.5rem]" /> {/* 49px, 120px, 200px */}
          </div>

          {/* Responsive Grid Layout */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 xl:gap-10 relative">
            {/* Vertical divider for medium+ screens */}
            <div className="hidden md:block absolute top-0 bottom-0 2xl:left-[47%] w-px bg-[#F4D48D] transform -translate-x-1/2 2xlplus:left-[48%]"></div>

            {/* Safety */}
            <div>
              <h4 className="text-[2rem] text-[#F4D48D] font-semibold mb-4 2xl:text-[2rem] 2xlplus:text-[4rem]"> {/* 32px */}
                Safety
              </h4>
              <p className="text-[1.125rem] text-gray-300 2xlplus:text-[1.5rem]"> {/* 18px */}

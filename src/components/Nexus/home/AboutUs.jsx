...
const AboutUs = () => {
  return (
    <div className="relative text-white overflow-hidden ">
      ...
      {/* Content Container */}
      <div className="relative z-10  gap-0 max-w-[1920px] mx-auto xl:pt-20 xl:pb-64 flex flex-col lg:flex-row xl:gap-16 lgplus:top-[8rem] xlplus:top-4 
      2xl:top-[0.2rem]">
        {/* Left Column */}
      ...
      <div className="relative z-20 mt-4 2xl:-mt-[27rem]  px-6 md:px-12 lg:px-24 xl:px-24 max-w-[1920px] mx-auto
       lgplus:mt-[6rem] xlplus:-mt-[20rem] 2xlplus:-mt-[20rem]"> {/* 432px → 27rem */}
        <div className="rounded-lg shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 xl:gap-10 relative">
            ...
            {/* Safety */}
            <div>
              <h4 className="text-[2rem] text-[#F4D48D] font-semibold mb-4  lgplus:text-[3rem] 2xl:text-[2rem] 2xlplus:text-[4rem]"> {/* 32px */}
                Safety
              </h4>
              <p className="text-[1.125rem] text-gray-300  2xlplus:text-[1.5rem] lgplus:text-[1rem]"> {/* 18px */}

...
const OurPeople = () => {
  return (
    <div className="relative h-auto
      sm:h-[31.25rem] lg:h-[37.5rem] xl:h-[50rem]
     text-white overflow-hidden  ">
      {/* Background Strip using clip-path - Mobile height increased */}
      <div className="absolute top-0 left-0 w-full h-[30.625rem] sm:h-[25.125rem] lg:h-[31.375rem] xl:h-[43.875rem] xlplus:h-[45rem] z-0">
        ...
        xl:rounded-[1.25rem] xl:top-[38%] shadow-lg text-white flex flex-col justify-between mx-auto sm:mx-0">
          ...
          <div className="ml-[10%] p-4 sm:p-6 lg:p-8 xl:p-10 2xl:p-12">
            <div className="flex items-start gap-3">
              <img
                ...
                className="w-[4.5625rem] h-[4.5625rem] sm:w-[6.5rem] sm:h-[6.5rem] lg:w-[7.1875rem]
                 lg:h-[7.1875rem] xl:w-[10.25rem] xl:h-[10.25rem] xlplus:h-[9rem] xlplus:w-[9rem] rounded-full object-cover"
              />
            ...
            <div className="mt-4 sm:mt-6 lg:mt-8 xl:mt-10 max-w-[43.75rem] px-2 text-left ">
              <p className="text-[0.625rem] sm:text-[0.875rem] lg:text-[1rem] xlplus:text-[1.3rem] 2xl:text-[1.25rem] 2xlplus:text-[1.5rem]  leading-snug text-[#E5E5E5]">

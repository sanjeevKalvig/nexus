...
function AboutUs() {
    ...
    return (
        <div className='bg-[radial-gradient(at_top_left,_#05141D,_#03090D)] text-white py-12 sm:py-16 md:py-20 lg:py-28'>
            ...
            <div className='bg-[url("/assets/Blueprint.png")] bg-[length:80%] sm:bg-[length:70%] md:bg-[length:80%] bg-no-repeat bg-[position:100%_190%] sm:bg-[position:100%_180%] md:bg-[position:100%_190%] 

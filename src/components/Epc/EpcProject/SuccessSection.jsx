...
export default function SuccessSection() {
  return (
    <section className="relative isolate overflow-hidden bg-[#000E15]">
      ...
      <div aria-hidden className="pointer-events-none relative inset-0" />
      ...
      <div className="relative mx-auto max-w-[1300px] px-4 py-12 text-center sm:px-6 sm:py-14 md:px-8 md:py-16 xl:py-24">
        {/* Title */}
        <h2
          className="m-0 uppercase font-semibold tracking-[0.2em] text-[#D9B56D] sm:tracking-[0.25em] md:tracking-[0.35em]"
        ...
        <p className="mx-auto mt-8 max-w-2xl text-[14px] leading-6 text-[#C9D6DE] sm:mt-10 sm:text-[15px] sm:leading-6 md:mt-12 md:text-[16px] md:leading-7 xl:mt-16">
          At Nexus EPC, success is built on precision, performance, and
          partnerships. With a strong foundation in engineering excellence, we
          continue to deliver projects that redefine standards in quality,
        ...
        <div className="mt-12 grid grid-cols-2 gap-6 sm:mt-16 sm:gap-8 md:grid-cols-4 md:gap-10 xl:mt-24 xl:gap-12">
          ...
          <div className="flex flex-col items-center gap-2 sm:gap-3">
            ...
            <span className="text-xs text-[#C9D6DE] sm:text-sm xl:text-base">
              Buildings
            </span>
          </div>

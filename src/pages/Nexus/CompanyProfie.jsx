          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="p-6 border-2 border-[#00B4D8] rounded-lg bg-opacity-10">
              ...
              <p className="text-gray-300">
                ...
                business, and we strive to ensure each and every one feels
            ...
            <div className="p-6 border-2 border-[#00B4D8] rounded-lg bg-opacity-10">
              ...
              <p className="text-gray-300">
                Our goal is to provide clients with exceptional service and
                value, ensuring they return time and time again.
              </p>
            </div>
